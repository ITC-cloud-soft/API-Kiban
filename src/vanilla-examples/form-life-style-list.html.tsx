...
import { FormField, FormFieldRow, FormFieldRow1 } from 'design/components/molecules/form-field';
...
const SettingListPage: React.FC = () => (
  <html>
    <title>ライフスタイルプラン照会一覧</title>
    <body>
      <Whole navigation={<SettingHeader>ライフスタイルプラン照会一覧</SettingHeader>}>
        <Heading tag="h1">ライフスタイルプラン照会一覧</Heading>
        ...
        <Section noPadding={true} className="p-data-table-holder">
          <SearchCurrentFilters2 onClearClick={() => { }} dateFilterStart="" dateFilterEnd="">
            <Tag modifiers="filled">申請日：2021/02/03 ～ 2022/07/03</Tag>
        ...
        >
          <Section className="p-setting-input-form__body">
            <FormField label="決裁区分">   </FormField>
            ...
            <FormField label="申請事由">   </FormField>
            <FormFieldRow columnSize="12" columnSizePC="3">

              <Checkbox name="R3" value="6" checked modifiers="button">
                介護
              </Checkbox>
              <Checkbox name="R3" value="6" modifiers="button">
                看病・看護
              </Checkbox>
              <Checkbox name="R3" value="6" modifiers="button">
                結婚
            ...
            <FormField label="申請種別">   </FormField>
            <FormFieldRow columnSize="12" columnSizePC="4">

              <Checkbox name="R5" value="6" checked modifiers="button">
                転居制限
              </Checkbox>
              <Checkbox name="R5" value="6" modifiers="button">
                勤務エリア変更
              </Checkbox>
              <Checkbox name="R5" value="6" modifiers="button">
                ペア転勤
            ...
            <br />
            {/* <FormField label="適用期間残月数">   </FormField>
            <FormFieldRow1 columnSize="12" columnSizePC="2">
            ...
            <FormFieldRow columnSize="12" columnSizePC="6">
              ...
              <FormField label="申請内容">
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <Checkbox name="R6" value="6" checked modifiers="button">
                    適用
                  </Checkbox>

                  <Checkbox name="R6" value="6" modifiers="button">
                    解除
                  </Checkbox>
                </FormFieldRow>
              </FormField>
            ...
            <FormFieldRow columnSize="12" columnSizePC="6">
              <FormField label="適用/解除開始日" className="p-setting-input-form__form-field">
                <FormFieldRow columnSize="12" columnSizePC="12">
                  <CalendarField defaultValue={new Date('2022-03-26T20:44:23.000Z')} onDateChange={() => { }} />
                </FormFieldRow>
              </FormField>

              <FormField label="適用/解除終了日" className="p-setting-input-form__form-field">
                <FormFieldRow columnSize="12" columnSizePC="12">
                  <CalendarField defaultValue={new Date('2022-03-26T20:44:23.000Z')} onDateChange={() => { }} />
                </FormFieldRow>
              </FormField>
