...
import { InfoTableLoose, InfoTableProps } from '.';
...
export default {
  title: 'components/molecules/InfoTableLoose',
  component: InfoTableLoose,
} as Meta;

const Template: Story<InfoTableProps> = args => <InfoTableLoose {...args} />;
