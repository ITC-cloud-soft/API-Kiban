...
import { NavIcon, NavIconShape } from 'design/components/atoms/nav-icon';
import { Icon } from 'design/components/atoms/icon';

export interface NavItemProps {
  modifiers?: ModifierProp<'menu-item'>;
  icon?: NavIconShape;
  badge?: boolean;
  selected?: boolean;
...
export const NavItem: React.FC<NavItemProps> = ({
  ...
  return (
    <div className={className} id={id} ref={self} data-remote-subnav={remoteSubNav}>
      <a
        href={children || remoteSubNav ? undefined : href}
