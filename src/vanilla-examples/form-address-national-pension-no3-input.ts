...
document.addEventListener('DOMContentLoaded', () => {
  ...
  //初期表示
  const modalinputBodyEl: any = document.getElementById('full-modal-input');
  if (modalinputBodyEl) {
    const modalinputBodyElBody = modalinputBodyEl.__component as Modal;
    console.log(modalinputBodyElBody);
    modalinputBodyElBody.opened = true;
    modalinputBodyElBody.onCloseRequested = () => (modalinputBodyElBody.opened = false);
  }
