        ...
        >
          <>
            <div className="p-wrapper">
              ...
              <FormFieldRow columnSize="12" columnSizePC="6">
                <FormField label="被扶養者との続柄"
                >
                  <Pulldown name="something" placeholder="配偶者">
              ...
              <FormField label="入籍日" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <CalendarField defaultValue={new Date('2022-03-26T20:44:23.000Z')} onDateChange={() => { }} />
                </FormFieldRow>
              </FormField>
              <FormField label="入籍日（和暦）" className="p-setting-input-form__form-field">
                <FormFieldRow columnSize="12" columnSizePC="6">
              ...
              <Text>
                あなた（被保険者）と申請するご家族の住民票が分かれている場合、双方の世帯全員分の準民票【原本】と続柄がわかる戸籍抄
                <br />本【原本】を提出してください。 <br />
              ...
              <FormField label="理由" className="p-setting-input-form__form-field" >
                ...
                <FormFieldRow columnSize="12" columnSizePC="12">
                  <TextField name="name" type="text" value="理由あああ" />
                </FormFieldRow>
                <br />
                <FormFieldRow columnSize="12" columnSizePC="12">
                  <InfoTableNone>  <div className="o-form-nobottom">
                    ...
                    <FormField label="添付書類"  >
                      <Text>
                        離職票1と2【原本】または雇用保険被保険者資格喪失確認通知書【写し】  <br />
                        <br />
                        ※後日こちらから送付の「誓約書」を提出いただきます。  <br />
                        ※離職票【原本】は確認後お返しします。
                      </Text>
                    </FormField>   </div>
                  </InfoTableNone>
