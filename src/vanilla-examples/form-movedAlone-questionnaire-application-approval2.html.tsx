        ...
        >
          <>
            <div className="p-wrapper">
              ...
              <FormField label="経済的援助適用見込期間" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                <FormFieldRow columnSize="12" columnSizePC="6">
              ...
              <FormField label="単身赴任手当"  >
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <UnitTextField defaultValue="20,000" name="text" type="text" unit="unit-yen" />
                </FormFieldRow>
              </FormField>

              <FormField label="異動前社宅費・住宅助成金" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                <FormFieldRow columnSize="12" columnSizePC="6">
              ...
              <FormField label="異動後社宅費・住宅助成金" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <div className={mapModifiers('a-address-search-field')}>
                    <UnitTextField />
                    <Button type="button" modifiers="third" >
