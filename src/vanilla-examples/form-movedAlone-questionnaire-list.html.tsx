...
import { SettingHeaderForBack } from 'design/components/molecules/setting-header';
...
const SettingListPage: React.FC = () => (
  <html>
    ...
    <body>
      ...
      <Whole navigation={<SettingHeaderForBack></SettingHeaderForBack>}>
        <Heading tag="h1">所属一覧</Heading>
        <Modal
          id="modal-comp"
        ...
        <Section noPadding={true} className="p-data-table-holder">
          <SearchCurrentFilters2 onClearClick={() => { }} dateFilterStart="" dateFilterEnd="">
            <Tag modifiers="filled">所属名称：システム</Tag>
                ...
                },
                {
                  value: (
                    <ButtonContainer modifiers="border">
                      <Button modifiers="text">選択</Button>
                    </ButtonContainer>
                  ),
                },
