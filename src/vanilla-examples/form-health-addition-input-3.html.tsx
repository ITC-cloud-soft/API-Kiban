          ...
          <>
            <div className="p-wrapper">
              ...
              <FormField label=" 上記どれにも該当しない場合は、以下を選択してください" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <Radio name="re" value="5" checked modifiers="grey">
                    任意継続被保険者
                  </Radio>
                  <Radio name="re" value="6" modifiers="grey">
                    その他
                  </Radio>
              ...
              <FormField label="退職日" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                <FormFieldRow columnSize="12" columnSizePC="6">
              ...
              <FormFieldRow columnSize="12" columnSizePC="6">
                <FormField label="配偶者の被保険者証（記号）" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <TextField name="name" type="text" value="8" />
                </FormField>
                <FormField label="配偶者の被保険者証（番号）" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <TextField name="name" type="text" value="123456" />
                </FormField>
              </FormFieldRow>

              <FormFieldRow columnSize="12" columnSizePC="6">
                <FormField label="配偶者の姓" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <TextField name="name" type="text" value="伊音" />
                </FormField>
                <FormField label="配偶者の名" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
              ...
              <FormFieldRow columnSize="12" columnSizePC="12">
                <InfoTableNone> <div className="o-form-nobottom">
                  <FormField label="添付書類" >
                    <Text>
                      離職票1と2【写し】または退職証明書【原本】<br />
                      <br />
                      ※後日こちらから送付の「誓約書」と「雇用保険受給資格者証【写し】」を提出いただきます。
