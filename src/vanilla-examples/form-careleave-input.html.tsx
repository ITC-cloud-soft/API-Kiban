...
const FamilyMarriageInputForm: React.FC = () => (
  <html>
    <title>介護休職（新規・更新・変更申請）</title>
    <body>
      <Whole navigation={''}>
        {/* 介護休職（新規・更新・変更申請）入力画面 */}
        <Modal
          ...
          <>
            <div className="p-wrapper">
              <Section className="p-setting-input-form__heading" modifiers="border">
                <Heading tag="h1">介護休職（新規・更新・変更申請）</Heading>
                <Text>
                  XXXXXXX（説明文言未定）
                  <br />
        ...
        >
          <>
            <div className="p-wrapper">
              ...
              {/* ライフスタイルプラン区域 */}
              <Heading tag="h3">ライフスタイルプラン</Heading>
              <FormField label="現在適用制度" className="p-setting-input-form__form-field">
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <Text>ペア転勤制度/配偶者転居制限希望する</Text>
                </FormFieldRow>
              </FormField>
              <div className="m-info-table__header"></div>
              <br />
