          ...
          <>
            <div className="p-wrapper">
              <Section className="p-setting-input-form__heading" modifiers="border">
                <Heading tag="h1">介護勤務（撤回・終了申請）</Heading>
                <Text>
                  介護勤務の撤回は、介護勤務を申請したが、全て取得せずを取りやめる事です。
                  <br />
                  介護勤務開始予定日の前日までに申し出る必要があります。
                </Text>
                <br />
              </Section>
              <br />
                ...
                instruction={
                  <CaptionList>
                    <React.Fragment key=".0">
                      ※当初の申請より早く介護勤務を終了する場合は、月度終了日の締め日が終了日となります。
                      <br />
                      ・10日締めの場合、10日。
                      <br />
                      ・20日締めの場合、20日。
