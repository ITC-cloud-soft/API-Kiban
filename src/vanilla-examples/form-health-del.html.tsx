          ...
          <>
            <div className="p-wrapper">
              <Section className="p-setting-input-form__heading" modifiers="border">
                <Heading tag="h1">健康保険扶養 (削除申請)</Heading>
                <Text>
                  XXXXXXX（説明文言未定）
                  <br />
                  YYYYYYYY
              ...
              <br />
              <Text>
                扶養から削除したい該当の被扶養者を、「被扶養者を削除する」ボタンで選択してください。
                <br />
                削除したい被扶養者が複数いる場合は、本画面より繰り返し情報入力を行ってください。
                <br />
              ...
              <FormField label="異動の種類">
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <TextField name="name" type="text" disabled value="削除" />
                </FormFieldRow>
              </FormField>
              ...
              <VisitRecordInputCust handleCloseClick={() => {}} haveclose={false} title="被扶養者（1人目）">
                ...
                <br />
                <CustItemButton handleCustItemClick={() => {}} icon={<Icon name="minus" />}>
                  被扶養者（1人目）を削除する
                </CustItemButton>
              ...
              <VisitRecordInputCust
                ...
                title={
                  <>
                    被扶養者（2人目）　<span className="m-form-field__label a-text a-text--purple">※削除入力済</span>
                  </>
                }
              >
                <InfoTable modifiers="no-border-header">
        ...
        >
          <>
            <div className="p-wrapper">
              ...
              <br />
              <ApprovalStatusList>
                <ApprovalStatusItem done time="" title="削除申請">
