        ...
        <Modal
          ...
          footer={
            <>
              ...
              {/* <Button modifiers="errstop" size="huge" id="input-form-check-button" > */}
              <Button size="huge" id="input-form-check-button" disabled={true} >
            ...
            <div className="p-wrapper">
              ...
              <FormFieldRow columnSize="12" columnSizePC="12">
                <InfoTableNone> <div className="o-form-nobottom">
                  ...
                  <FormFieldRow columnSize="6" columnSizePC="6">
                    <Radio name="R4" value="6" modifiers="grey">
                      はい
                    </Radio>
                    <Radio name="R5" value="6" checked modifiers="grey">
                      いいえ
                    </Radio>
                  </FormFieldRow>  <br />
                </div> </InfoTableNone>
              ...
              <Text>
                ...
                <p className="a-text--purple ">
                  その家族は被扶養者資格がありません。  <br />
                  今回申請のご家族の場合、同居別居・送金状況等の条件により  <br />
                  被扶養者として申請はできません。 <br />
                  より詳しいことを知りたい場合は、Q&Aを確認してください。 <br />
                </p>
                回答内容をあらためてご確認いただくか、  <br />
                以下より、健康保険扶養のトップ画面にお戻りください。  <br />
              </Text>
