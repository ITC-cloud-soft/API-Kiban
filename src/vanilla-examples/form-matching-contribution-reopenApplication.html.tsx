...
const MatchingContributionReopenApplication: React.FC = () => (
  <html>
    <body>
      <Whole navigation={''}>
        <Modal
          ...
          <>
            <div className="p-wrapper">
              ...
              <Section className="p-setting-input-form__heading">
                <Heading tag="h1">マッチング拠出　再開申請</Heading>
                <Text>
                  XXXXXXX（説明文言未定）
                  <br />
                  YYYYYYYY
              ...
              <Section className="p-setting-input-form__body">
                ...
                <FormField label="">
                  <EmailTemplateViewer>
                    ...
                    <p>
                      本人情報の資格が更新されていない場合は、資格変更日（登用日）以後に申請を実施してください。
                    </p>
                  </EmailTemplateViewer>
                </FormField>
                ...
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <FormField label="再開希望月" className="p-setting-input-form__form-field" >
...
export default renderVanillaExample(<MatchingContributionReopenApplication />);
