        ...
        >
          <>
            <div className="p-wrapper">
              ...
              <br />
              <Text>
                被扶養者の情報入力は、「被扶養者を追加する」ボタンより行ってください。
                <br />
                被扶養者が複数いる場合は、本画面より繰り返し情報入力を行ってください。
                <br />
              ...
              <FormField label="異動の種類">
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <TextField name="name" type="text" disabled value="追加" />
                </FormFieldRow>
              </FormField>
        ...
        >
          <>
            <div className="p-wrapper">
              ...
              <br />
              <ApprovalStatusList>
                <ApprovalStatusItem done time="" title="追加申請">
