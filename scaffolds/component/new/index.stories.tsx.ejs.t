---
to: src/design/components/<%= h.inflection.pluralize(level) %>/<%= h.changeCase.param(name) %>/index.stories.tsx
sh: prettier --write src/design/components/<%= h.inflection.pluralize(level) %>/<%= h.changeCase.param(name) %>/index.stories.tsx
---
