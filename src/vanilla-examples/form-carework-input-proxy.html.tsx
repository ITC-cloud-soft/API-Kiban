...
const FamilyMarriageInputForm: React.FC = () => (
  <html>
    <title>介護勤務（新規・更新・変更代理申請）</title>
    <body>
      <Whole navigation={''}>
        {/* 介護勤務（新規・更新・変更代理申請）入力画面 */}
        <Modal
          ...
          <>
            <div className="p-wrapper">
              <Section className="p-setting-input-form__heading" modifiers="border">
                <Heading tag="h1">介護勤務（新規・更新・変更代理申請）</Heading>
                <Text>
                  XXXXXXX（説明文言未定）
                  <br />
              ...
              <FormField label="配偶者転居制限制度" className="p-setting-input-form__form-field">
                <FormFieldRow columnSize="6" columnSizePC="6">
