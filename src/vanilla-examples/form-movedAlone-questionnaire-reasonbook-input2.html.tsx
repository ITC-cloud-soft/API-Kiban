...
const MovedAloneQuestionnaireApplicationinput: React.FC = () => (
  <html>
    <title>病気看病による経済的援助適用申請理由書</title>
          ...
          <>
            <div className="p-wrapper">
              <Section className="p-setting-input-form__heading" modifiers="border">
                <Heading tag="h1">病気看病による経済的援助適用申請理由書</Heading>

                <Text>
                  医師又は、専門機関の意見欄について、本画面項目の入力後に、PDFファイル出力し、印刷したものを、医師又は、専門機関の方に、記載いただきます。
                </Text>
                <br />
              </Section>
              <br />
              ...
              <FormFieldRow columnSize="12" columnSizePC="6">
                <FormField label="所属名称" labelAddons={<Tag>必須</Tag>}>
              ...
              <div className="m-info-table__header"></div>
              <br />
              <Heading tag="h3">医療機関または、学校・訓練施設情報</Heading>
              <FormFieldRow columnSize="12" columnSizePC="12">
                <FormField label="名称"  >
                  <TextField name="name" type="text" disabled value="○○総合病院" />
                </FormField>
              ...
              <FormFieldRow columnSize="12" columnSizePC="6">
                ...
                <FormField label="通院・通学頻度" >
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Pulldown id="contel-start-time" placeholder="1ヶ月" name="contel-start-time">
                      <option value=""></option>
                      <option value="1">テスト１</option>
                      <option value="2">テスト２</option>
                    </Pulldown>
              ...
              <FormFieldRow columnSize="12" columnSizePC="6">
                <FormField label="対象者宅まで所要時間" className="p-setting-input-form__form-field" >
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <UnitTextField unit="unit-hour" />
                    <UnitTextField unit="unit-minute" />
                  </FormFieldRow>
              ...
              >
                <Section className="p-setting-input-form__body">
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <FormField label="氏名" className="p-setting-input-form__form-field" >
                      <TextField name="name" type="text" value="介助　智子" />
                    </FormField>
                    <FormField label="続柄" className="p-setting-input-form__form-field">
                      <Pulldown id="contel-start-time" placeholder="妻" name="contel-start-time">
                        <option value=""></option>
                  ...
                  <FormFieldRow columnSize="12" columnSizePC="12">
                    <FormField label="介護できない理由" className="p-setting-input-form__form-field" >
                      <TextField name="name" type="text" value="高齢のため（60歳）" />
                    </FormField>
                  </FormFieldRow>
