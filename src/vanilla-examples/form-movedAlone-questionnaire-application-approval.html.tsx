        ...
        >
          <>
            <div className="p-wrapper">
              ...
              <FormField label="確認日" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="12" columnSizePC="6">
              ...
              <FormFieldRow columnSize="12" columnSizePC="6">
                <FormField label="氏名" className="p-setting-input-form__form-field" >
                  <TextField name="name" type="text" disabled value="承認　太郎" />
                </FormField>

              </FormFieldRow>
              <FormFieldRow columnSize="12" columnSizePC="6">
                <FormField label="役職" className="p-setting-input-form__form-field" >
                  <TextField name="name" type="text" disabled value="千葉事業部　稲毛店管理課長" />
                </FormField>
