        ...
        >
          <>
            <div className="p-wrapper">
              ...
              <FormField label="変更日（和暦）" className="p-setting-input-form__form-field">
                <FormFieldRow columnSize="12" columnSizePC="6">
              ...
              <FormFieldRow columnSize="12" columnSizePC="12">
                <InfoTableNone> <div className="o-form-nobottom">
                  <FormField label="添付書類" >
                    <Text>
                      変更後の効用契約書【写し】か、今後の収入見込証明書【原本】  </Text>
                  </FormField>
                </div> </InfoTableNone>
              </FormFieldRow>
              <br />
              ...
              <FormFieldRow columnSize="12" columnSizePC="12">
                <InfoTableNone> <div className="o-form-nobottom">
                  <FormField label="添付書類" >
                    <Text>
                      離職票1と2【写し】または退職証明書【原本】または延長手続後の受給期間延長通知書【写し】<br />
                      <br />
                      ※後日こちらから送付の「誓約書」と「受給期間延長通知書【写し】」を提出いただきます。<br />
                    </Text>
                  </FormField>
                </div> </InfoTableNone>
              </FormFieldRow>  <br />
