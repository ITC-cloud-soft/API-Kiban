...
const MatchingContributionStartApplication: React.FC = () => (
  <html>
    <body>
      <Whole navigation={''}>
        <Modal
          ...
          <>
            <div className="p-wrapper">
              ...
              <Section className="p-setting-input-form__heading">
                <Heading tag="h1">マッチング拠出　開始申請</Heading>
                <Text>
                  XXXXXXX（説明文言未定）
                  <br />
                  YYYYYYYY
              ...
              <Section className="p-setting-input-form__body">
                ...
                <FormField label="">
                  <EmailTemplateViewer>
                    ...
                    <p>
                      マッチング拠出の開始期間は以下の年2回のみとなっています。</p>
                    <p>
                    ...
                    <p> 資格変更（昇格・降格）が直近であった場合、本画面の資格が更新されている事を確認してから申請してください。 </p>
                    <p>
...
export default renderVanillaExample(<MatchingContributionStartApplication />);
