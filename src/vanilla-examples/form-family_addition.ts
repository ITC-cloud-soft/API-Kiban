...
const modalHelpOpenerEl1: any = document.getElementById('help-opener1');
const modalHelp1: any = document.getElementById('modal-help1');
if (modalHelpOpenerEl1) {
  modalHelpOpenerEl1.addEventListener('click', () => {
    if (modalHelp1) {
      const modalBody = modalHelp1.__component as Modal;
      modalBody.opened = true;
      modalBody.onCloseRequested = () => (modalBody.opened = false);
    }
  });
