...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const confirmButtonSyouninn: any = document.getElementById('input-form-Syouninn-button');
  if (confirmButtonSyouninn) {
    const modalBodyESyouninn: any = document.getElementById('setting-Syouninn-modal');
    if (modalBodyESyouninn) {
      const modal = modalBodyESyouninn.__component as Modal;
      confirmButtonSyouninn.addEventListener('click', () => {
        modal.opened = true;
      });
      modal.onCloseRequested = () => (modal.opened = false);
      }
...
const confirmButton: any = document.getElementById('input-form-Hininn-button');
if (confirmButton) {
  const modalBodyE2: any = document.getElementById('setting-Hininn-modal');
  if (modalBodyE2) {
