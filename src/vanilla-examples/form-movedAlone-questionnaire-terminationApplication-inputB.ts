...
const modalHelpOpenerE2: any = document.getElementById('help-opener');
const modalHelp2: any = document.getElementById('modal-help');
...
const modalHelpOpenerE3: any = document.getElementById('help-opener2');
const modalHelp3: any = document.getElementById('modal-help2');
