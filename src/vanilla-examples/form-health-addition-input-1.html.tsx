            ...
            <div className="p-wrapper">
              ...
              <FormField label="設問2" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                ...
                <FormFieldRow columnSize="12" columnSizePC="6">
                  ...
                  <Radio name="RR3" value="6" checked modifiers="grey">
                    今回、配偶者も同時に申請
                  </Radio>
                  <Radio name="RR3" value="6" modifiers="grey">
                ...
                templateInput={
                  <>
                    <Section className="p-setting-input-form__body">
                      ...
                      <FormFieldRow columnSize="6" columnSizePC="6">
                        <Checkbox name="CC1" value="2" checked modifiers="button">
                          給与収入
                        </Checkbox>
                        <Checkbox name="CC1" value="2" checked modifiers="button">
                          自営業収入
                      ...
                      <FormFieldRow columnSize="12" columnSizePC="12">
                        <InfoTableNone>
                          <div className="o-form-nobottom">
                            <FormField label="添付書類（給与収入）" className="" >
                              <Text>
                                直近3ヵ月の給与明細【写し】
                                <br />
              ...
              >
                <Section className="p-setting-input-form__body">
                  ...
                  <FormFieldRow columnSize="6" columnSizePC="6">
                    <Checkbox name="CC2" value="2" checked modifiers="button">
                      給与収入
                    </Checkbox>
                    <Checkbox name="CC2" value="2" checked modifiers="button">
                      自営業収入
              ...
              <FormField label="老齢 基礎年金･構成年金" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR11" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR11" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
              ...
              <FormField label="遺族年金" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR12" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR12" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
              ...
              <FormField label="障害年金" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR13" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR13" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
              ...
              <FormField label="退職年金（共済組合･企業年金･厚生年金基金などからの年金）" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR14" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR14" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
              ...
              <FormField label="自営業収入、農業･行業･林業収入等" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR15" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR15" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
              ...
              <br />
              <FormFieldRow columnSize="6" columnSizePC="6">
                <Radio name="RR16" value="6" modifiers="grey">
                  収入無
                </Radio>
                <Radio name="RR16" value="6" checked modifiers="grey">
                  収入有
                </Radio>
              </FormFieldRow>
              <br />
              ...
              <FormField label="失業保険（求職者給付金）、育児･介護休業給付金、教育訓練給付金等）" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR17" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR17" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
              ...
              <FormField label="傷病手当金" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR18" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR18" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
              ...
              <FormField label="出産手当金" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR19" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR19" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
              ...
              <FormField label="休業（補償）給付金等" className="p-setting-input-form__form-field" >
                <FormFieldRow columnSize="6" columnSizePC="6">
                  <Radio name="RR20" value="6" modifiers="grey">
                    収入無
                  </Radio>
                  <Radio name="RR20" value="6" checked modifiers="grey">
                    収入有
                  </Radio>
                </FormFieldRow>
              </FormField>
