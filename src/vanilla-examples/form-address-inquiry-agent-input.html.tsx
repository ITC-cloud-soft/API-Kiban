...
const AddressInquiryAgentInputForm: React.FC = () => (
  <html>
          ...
          <>
            <div className="p-wrapper">
              ...
              <Section modifiers="border">
                ...
                <FormField label="婚姻区分" labelAddons={<Tag>必須</Tag>}>
                  <FormFieldRow columnSize="6" columnSizePC="6">
                    <Radio name="dependent" value="yes">
                      独身者
                    </Radio>
                    <Radio name="dependent" value="no" checked>
                      既婚者
                    </Radio>
                  </FormFieldRow>
                </FormField>
                ...
                <FormField label="変更後の状況について" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  ...
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Radio name="dependent1" value="no">
                      家族同居
                    </Radio>
                    <Radio name="dependent1" value="no">
                      経済的援助あり単身赴任
                    </Radio>
                    <Radio name="dependent1" value="yes" checked >
                      経済的援助なし単身赴任
                    </Radio>
                  </FormFieldRow>
                </FormField>
                <FormField label="社宅費申請住居区分" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <Text align="left" className="">
                  ...
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Radio name="dependent2" value="yes">
                      現住居
                    </Radio>
                    <Radio name="dependent2" value="no" checked >
                      家族住居
                    </Radio>
                  </FormFieldRow>
                </FormField>
              ...
              <Section modifiers="border">
                ...
                <FormField label="変更有無区分" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Radio name="dependent3" value="yes">
                      変更あり
                    </Radio>
                    <Radio name="dependent3" value="no" checked >
                      変更なし
                    </Radio>
                  </FormFieldRow>
                </FormField>
                ...
                <FormField label="市区町村コード" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <FormFieldRow columnSize="12" columnSizePC="6">
              ...
              <Section modifiers="border">
                ...
                <FormField label="変更有無区分" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Radio name="Radio0" value="yes" checked>
                      変更あり
                    </Radio>
                    <Radio name="Radio0" value="no"  >
                      変更なし
                    </Radio>
                  </FormFieldRow>
                </FormField>
                <FormField label="本人住所選択" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Radio name="Radio1" value="yes" checked>
                      本人住所と同じ
                    </Radio>
                    <Radio name="Radio1" value="no"  >
                      本人住所と別
                    </Radio>
                    <Radio name="Radio1" value="no"  >
                      削除
              ...
              <Section modifiers="border">
                <Heading tag="h3">社宅・社宅助成金（現住居）確認情報</Heading>
                ...
                <FormField label="婚姻" labelAddons={<Tag>必須</Tag>} >
                  <FormFieldRow columnSize="12" columnSizePC="6">
                ...
                {/* <FormField >
                  <button className="m-accordion__label m-form-field__label" id="linkcheck">
                    住宅助成金・社宅費算出
                    <Icon name='unit-phone' />
                  </button>
                  <br />
                </FormField> */}
                <FormFieldRow columnSize="12" columnSizePC="12">
                  ...
                  >
                    <UploadFieldSingle description="形式：jpg/png/pdf | サイズ：10MBまで">
              ...
              <Section modifiers="border">
                <Heading tag="h3">社宅・社宅助成金（家族住居）確認情報</Heading>
                <FormField label="住居区分" className="p-setting-input-form__form-field" >
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <TextField name="name" type="text" disabled value="自己賃貸" />
                  </FormFieldRow>
              ...
              <Section modifiers="border">
                ...
                <FormField label="変更有無区分" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Radio name="Radio2" value="yes" checked>
                      変更あり
                    </Radio>
                    <Radio name="Radio2" value="no"  >
                      変更なし
                    </Radio>
                  </FormFieldRow>
                </FormField>
              ...
              <Section modifiers="border">
                ...
                <FormField label="変更有無区分" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Radio name="Radio4" value="yes" checked>
                      変更あり
                    </Radio>
                    <Radio name="Radio4" value="no"  >
                      変更なし
                    </Radio>
                  </FormFieldRow>
                </FormField>
                <FormField label="本人住所選択" className="p-setting-input-form__form-field" labelAddons={<Tag>必須</Tag>}>
                  <FormFieldRow columnSize="12" columnSizePC="6">
                    <Radio name="Radio5" value="yes" checked>
                      本人住所と同じ
                    </Radio>
                    <Radio name="Radio5" value="no"  >
                      本人住所と別
                    </Radio>
            ...
            <div className="p-wrapper">
              ...
              <Section modifiers="border">
                ...
                <FormFieldRow columnSize="12" columnSizePC="6">
                  ...
                  <FormField label="本人住所選択">
                    <Text align="left">本人住所と別</Text>
                  </FormField>
                </FormFieldRow>
                <FormFieldRow columnSize="12" columnSizePC="6">
                  <FormField label="郵便番号">
...
export default renderVanillaExample(<AddressInquiryAgentInputForm />);
