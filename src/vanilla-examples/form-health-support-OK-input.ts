...
const backButton: any = document.querySelector('.a-modal-back-button');
  ...
  const modalSchoolOpenerEl: any = document.getElementById('help-opener1');
    const modalSchool: any = document.getElementById('modal_financial_info1');
    ...
    const modalSchoolOpenerEl2: any = document.getElementById('help-opener2');
    const modalSchool2: any = document.getElementById('modal_financial_info2');
    if (modalSchoolOpenerEl2) {
      modalSchoolOpenerEl2.addEventListener('click', () => {
        if (modalSchool2) {
          const modalBody = modalSchool2.__component as Modal;
          modalBody.opened = true;
          modalBody.onCloseRequested = () => (modalBody.opened = false);
        }
      });
