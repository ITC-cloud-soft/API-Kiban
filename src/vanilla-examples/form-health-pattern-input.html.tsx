          ...
          <>
            <div className="p-wrapper">
              ...
              <ApprovalWorkflow modifiers="auto">
                <ApprovalStepNo isDone modifiers="auto" step={1} name="申請家族選択" name2="申請家族選択" />
                <ApprovalStepNo isDone modifiers="auto" step={2} name="扶養要件判定" name2="扶養要件判定" />
                <ApprovalStepNo
                  isDone
                  modifiers="auto"
                  step={3}
                ...
                />
                <ApprovalStepNo modifiers="auto" step={5} name="被扶養者現況届" name2="被扶養者現況届" />
              </ApprovalWorkflow>
              <br />
              <Text>
